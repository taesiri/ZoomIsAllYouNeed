...
if experiment == "imagenetc":
    ...
    levels = [0]
elif experiment == "imagenet1k_full":
    corruptions = ["imagenet1k_full"]
    levels = [0]
elif experiment == "imagenet-sketch":
    corruptions = ["imagenet-sketch"]
    levels = [0]
elif experiment == "objectnet":
    corruptions = ["objectnet"]
    levels = [0]
